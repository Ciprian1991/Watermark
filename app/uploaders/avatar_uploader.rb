...
class AvatarUploader < CarrierWave::Uploader::Base
  ...
  def watermark
    manipulate! do |img|
      ...
      white_canvas.opacity = Magick::QuantumRange - (Magick::QuantumRange * model.alpha.to_i/100)
      ...
      corner = "Magick::#{model.position}".constantize
      img.composite(logo_opacity, corner, 0, 0, Magick::OverCompositeOp)
    end
  end
